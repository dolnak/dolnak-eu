...
$base_slash = $base .'/';
$gtag_id = 'UA-111762222-4';
$year = date("Y");
$author = "© 2014 - $year Ivan DOLNÁK. Všetky práva vyhradené.";
$title_suffix = ' | IVAN DOLNÁK';
$title .= $title_suffix;
$uri = $_SERVER['REQUEST_URI'];
$url = $base .$uri;
$canonical = 'https://www.dolnak.eu' .$uri;
        ...
        <div class="row">
          <div class="col mx-auto">
            <nav class="navbar navbar-dark bg-dark">
              <a class="navbar-brand" href="/">IVAN DOLNÁK</a>
            </nav>
          </div>
          <div class="col-lg-3 col-md-4">
            <nav class="navbar navbar-dark bg-dark">
              <a class="navbar-brand" href="https://sk.linkedin.com/in/dolnak">
                <i class="fab fa-linkedin-in"></i>
              </a>
              <a class="navbar-brand" href="https://www.facebook.com/ivan.dolnak">
                <i class="fab fa-facebook-f"></i>
              </a>
              <a class="navbar-brand" href="https://github.com/dolnak">
                <i class="fab fa-github"></i>
              </a>
              <a class="navbar-brand" href="https://www.youtube.com/playlist?list=FLrL9aWtO8KmvTFtGx-MuGKg">
